...
def doc_to_text_amh_t1(doc):
    if T == '1':
        result = output[0].format(language='English',Proverb=doc["translate"],A=doc['A'],B=doc['B'],C=doc['C'],D=doc['D'])
    if T == '2':
        result = output[1].format(Proverb=doc["translate"],A=doc['A'],B=doc['B'],C=doc['C'],D=doc['D'])
    if T == '3':
        result = output[2].format(language='English',Proverb=doc["translate"],A=doc['A'],B=doc['B'],C=doc['C'],D=doc['D'])
    return result
